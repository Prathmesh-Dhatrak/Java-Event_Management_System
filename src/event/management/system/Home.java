...
public class Home extends JFrame implements ActionListener {
    ...
    public Home() {
        ...
        JMenuItem eventdetails = new JMenuItem("Event Details");
        eventdetails.addActionListener(this);
        eventdetails.setBackground(new Color(211, 211, 211));
        eventdetails.setForeground(Color.DARK_GRAY);
        mnRecord.add(eventdetails);
        ...
        l1.setBounds(218, 30, 701, 80);
        contentPane.add(l1);

        JLabel l2 = new JLabel("");
        l2.setVerticalAlignment(SwingConstants.TOP);
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("event/management/system/icons/second.png"));
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("event/management/system/icons/third.png"));
        ...
        ImageIcon i7 = new ImageIcon(ClassLoader.getSystemResource("event/management/system/icons/fourth.png"));
        ...
        panel.setBorder(new TitledBorder(new LineBorder(new Color(250, 88, 114), 2), "Operation", TitledBorder.LEADING,
                TitledBorder.TOP, null, new Color(220, 20, 60)));
        panel.setBounds(20, 120, 750, 260);
        panel.setBackground(Color.WHITE);
        contentPane.add(panel);

        b4 = new JButton("Register Event");
        ...
        b5 = new JButton("Add Payment details");
        b5.addActionListener(this);
        b5.setBackground(Color.BLACK);
        b5.setForeground(Color.WHITE);
        b5.setBounds(320, 620, 159, 41);
        contentPane.add(b5);
        ...
        ImageIcon i10 = new ImageIcon(ClassLoader.getSystemResource("event/management/system/icons/fifth.png"));
        ...
        ImageIcon i13 = new ImageIcon(ClassLoader.getSystemResource("event/management/system/icons/sixth.png"));
        ...
        ImageIcon i16 = new ImageIcon(ClassLoader.getSystemResource("event/management/system/icons/seventh.png"));
        ...
        panel2.setBorder(new TitledBorder(new LineBorder(new Color(205, 113, 63), 2), "Action", TitledBorder.LEADING,
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        } else if (msg.equals("Event Details")) {
            setVisible(false);
