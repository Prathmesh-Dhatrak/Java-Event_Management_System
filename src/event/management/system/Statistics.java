...
public class Statistics extends JFrame {
    ...
    public void issueBook() {
        try {
            conn con = new conn();
            String sql = "select * from registerevent";
    ...
    public Statistics() {
        ...
        panel.setBorder(new TitledBorder(new LineBorder(new Color(47, 79, 79), 2, true), "Event-Registration-Details",
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("event/management/system/icons/tenth.png"));
        ...
        panel_1.setBorder(new TitledBorder(new LineBorder(new Color(0, 204, 153), 2, true), "Event-Payment-Details",
