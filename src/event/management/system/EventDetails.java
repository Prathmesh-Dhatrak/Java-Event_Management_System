...
public class EventDetails extends JFrame implements ActionListener {
    ...
    public EventDetails() {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("event/management/system/icons/eight.png"));
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("event/management/system/icons/nineth.png"));
        ...
        JLabel l1 = new JLabel("Event Details");
        ...
        ImageIcon i7 = new ImageIcon(ClassLoader.getSystemResource("event/management/system/icons/tenth.png"));
        ...
        panel.setBorder(new TitledBorder(new LineBorder(new Color(0, 128, 128), 3, true), "Event-Details",
    ...
    public void actionPerformed(ActionEvent ae) {
        try {
            ...
            if (ae.getSource() == b1) {
                ...
                String sql = "select * from event where concat(title, event_id) like ?";
                PreparedStatement st = con.c.prepareStatement(sql);
            ...
            if (ae.getSource() == b2) {
                String sql1 = "SELECT * FROM `event` WHERE `title` = '" + search.getText() + "'";
                PreparedStatement st1 = con.c.prepareStatement(sql1);
                ResultSet rs1 = st1.executeQuery();
                while (rs1.next()) {
                    id = rs1.getString("event_id");
                }
